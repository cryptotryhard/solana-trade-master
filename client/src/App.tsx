...
import VictoriaLiveDashboard from "@/pages/VictoriaLiveDashboard";
import NotFound from "@/pages/not-found";

function Router() {
  return (
    <Switch>
      <Route path="/" component={BillionaireDashboard} />
      ...
      <Route path="/victoria-live" component={VictoriaLiveDashboard} />
